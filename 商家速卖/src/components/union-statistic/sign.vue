  ...
  <scroll 
    ...
    <div class="count_list">
      <div class="item" v-for="item in listData">
        ...
        <div class="time">
          <p>报名方式: <span>{{item.type===0?'线上':'线下'}}</span></p>
        </div>
        <div class="time">
          <p>签到时间: <span>{{item.time}}</span></p>
        </div>
      </div>
      <!-- <div class="item">
        <div class="user_info">
        ...
        <div class="time">
          <p>参与活动: <span>xxxxx</span></p>
        </div>
        <div class="time">
          <p>报名方式: <span>xxxxx</span></p>
        </div>
        <div class="time">
          <p>签到时间: <span>2016-10-10</span></p>
        </div>
      </div> -->
