    ...
    <scroll 
      ...
      <div class="count_list">
        <div class="item" v-for="item in listData">
          <div class="user_info">
            <div class="line_horizontal"></div><div class="user_name">{{item.name}}</div><div class="phone">{{item.mobile}}</div>
          </div>
        ...
        <!-- <div class="item">
          <div class="user_info">
            <div class="line_horizontal"></div><div class="user_name">张三</div><div class="phone">13112345678</div>
          </div>
          <div class="time">
      ...
      <no-data :listData="listData" class="data-count"></no-data>
    </scroll>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      getListData() {
        loadData('analytics/getApplications', {
    ...
    //   if (from.name === 'shop-statistic') {
    //     next(vm => {
    //       vm.isShowRecommend = true
    //     })
    //   } else {
    //     next()
    //   }
