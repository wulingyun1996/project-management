<template>
  <div class="share">
    <div class="content">
      <div class="logo"></div>
      <img src="./share.png">
      <p>下载<span>建材商家速卖</span>  发现更多<span>商机</span></p>
      <div class="btn" id="downloadApp" @click="staticticsDownLoad">打开APP</div>
    </div>
  </div>
</template>
...
<style lang="stylus">
  ...
  .share
    ...
    right: 0
    bottom: 0
    background: #d7eefe url('shareBg.png') no-repeat center 135px
