<template>
  <div class="boutique-materials-container" :class="{ active: !hasNoData }">
    ...
    <div class="fotter-tel" v-show="!hasNoData">
      <span>想要更多商品加入精品馆，赶快联系我们，tel:{{ servicePhone }}</span>
    </div>
  </div>
</template>
