...
<template>
  <div class="apply-container apply-container-wrapper">
    ...
    <div class="wrapper">
      ...
      <!-- <div class="bg-gray" v-show="this.page === 0 ? true:false"></div> -->
        ...
        <div class="step-content">
          ...
          <div class="step-all-two" v-if="showSteptwo">
            ...
            <div class="apply-pic">
              ...
              <!-- 授权证书 -->
              <!-- <div class="photo photo-brand no" v-for="(item, index) in brandAccreditBook" @click="upLoad(2, index)" :key='index'>
                <img :src="item" alt="">
    ...
    <!-- <div ref="button" v-show="this.page === 0" class="button" :class="{ active: isActive }" @click="submit">
  ...
  methods: {
    ...
    submitBtn(type) {
      ...
      if (type === 1) {
        ...
        this.shopStatus = 2
        this.sendData(type)
        // this.$router.push({ path: '/topspeed-set-shop' })
      }
    },
    sendData(type) {
  ...
  .wrapper
    ...
    .apply-up
      ...
      .step-bar
        ...
        flex-center()
        span:nth-child(1)
          background url('icon-first-step.png') no-repeat center
          width 294px
          height 54px
        ...
        span:nth-child(2)
          ...
          display inline-block
        .noActive
          background url('./icon-editing.png') no-repeat center
        .activeT
          background url('./icon-second-step.png') no-repeat center
        span:nth-child(3)
          position absolute
          left 125px
          color #fff
      ...
      .step-all-two
        ...
        .apply-pic
          ...
          .photo-licence
            ...
            background-size 100% 100%
          .photo-brand
            background url('./icon-auth.png') no-repeat center
            background-size 100% 100%
        .step-two-des-down
          margin-top 62px
...
.buttonTwo
    ...
    .keep-saveBtn
      ...
      position relative
      span:nth-child(1)
        background url('./icon-detailsOne.png') no-repeat center top
        background-size 100% 100%
        width 46px
        height 40px
        display block
      ...
      span:nth-child(2)
        // margin-left 50px
      span:nth-child(3)
        background url('./icon-statement-left.png') center top
        width 44px
        height 44px
        display block
        position absolute
    ...
    .keep-saveBtnT
      ...
      position relative
      span:nth-child(1)
        background url('./icon-detailsTwo.png') center top
        background-size 100% 100%
        position absolute
        width 46px
        height 42px
      ...
      span:nth-child(2)
        // margin-left 50px
      span:nth-child(3)
        background url('./icon-statement.png') center top
        width 44px
        height 44px
        display block
        position absolute
