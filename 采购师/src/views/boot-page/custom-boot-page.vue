<template>
  <div class="custom-page">
    <div class="content">
      <div v-html="content" style="flex: 1; overflow: auto; -webkit-overflow-scrolling: touch;">
      </div>
    ...
    jump () {
      ...
      try {
        if (currentDev === 'Android') {
          window.android.nativeJumpWxmin()
          return
        }
        if (currentDev === 'iOS') {
          window.webkit.messageHandlers.nativeJumpWxmin.postMessage('')
        }
      } catch (e) {
        console.warn(e)
      }
