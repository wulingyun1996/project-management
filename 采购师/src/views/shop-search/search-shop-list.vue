  ...
  <div class="search-list-container">
    <!-- <div class="search-header" :class="{ 'ipone-x': isIponeX, 'ipone': isPone }">
      ...
      <div class="header-center">
        ...
        <input type="text" v-model="title" @click="goBack">
        <div class="close">
    ...
    <base-header :is-show-title="false" v-show="this.$route.query.isInsert !== '1'">
    ...
    <div class="synthesize-container" v-if="currentTab === 0">
      ...
      <!-- 综合缺省页 -->
      <div class="no-data" v-show="firstNoData">
        <img src="./images/icon-no.png" alt="">
        <p>没有找到对应的店铺,换一个关键词试试吧~</p>
        <!-- <p>换一个关键词试试吧</p> -->
      </div>
    </div>
    <!-- 可认证 -->
...
export default {
  ...
  methods: {
    ...
    // 去店铺详情页
    goShopDetail (id) {
      if (this.$route.query.isInsert === '1') {
        invokeNativeMethod('openView', JSON.stringify({ 'url': 'cgs://web', 'param': { 'shortUrl': '/shop-detail?fromNative=1&isNative=1&id=' + id } }))
      } else {
        this.$router.push({
          path: '/shop-detail',
          query: {
