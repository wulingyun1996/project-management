<template>
  <div class="cgs-header-container"
    :class="{ 'ipone-x': isIponeX && !inWx, 'ipone': isPone && !inWx }"
    v-show="!isSharedPage"
    v-if="isShowHeader">
    <div class="cgs-header-wrapper">
...
export default {
  ...
  methods: {
    ...
    openByTencent () {
      ...
      if (!!UA.match(/MicroMessenger/i) || !!UA.match(/QQ/i)) this.isHideSharedHeader = true
    }
  },
  watch: {
    title (val) {
